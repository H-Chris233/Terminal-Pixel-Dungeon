...
mod combat_tests {
    ...
    use crate::status_effect::{StatusEffectManager, StatusEffectCombatant};
    ...
    impl Combatant for TestCombatant {
        ...
        fn dexterity(&self) -> u8 { self.dexterity }
        fn intelligence(&self) -> u8 { self.intelligence }
    }
    ...
    fn test_ambush_combat() {
        ...
        assert!(ambush_result.logs.iter().any(|log| log.contains("Ambush") || log.contains("2x damage bonus")));
    }
